...
define(['components/info','jquery'],function(info,$){
	var aa={};
	 aa={
	 	//props:["res"],
		name:"applyCard",
		template: '<div><div class="applyCard-wrap">'
                ...
                +'<div class="container-title">'
                   ...
                   +' </div>'
                    ...
                    +'<div class="step step-7">'
                        +'<h1>留下您的联系方式，让我们保持联系</h1><h4>Leave your contact information, lets keep in touch</h4>'
                    +'</div>'
                    +'<div class="step step-9">'
                        +'<h1>不要忘记取走您的银行卡和身份证</h1><h4>Dont forget to take your bank card and ID card</h4>'
                    +'</div>'
                +'</div>'
               ...
               +' <div class="container-right-section">'
                    ...
                    +'<div class="step step-3" data-step=3>'
                      +'  <div class="swiper-container-contractPreview">'
                        +'    <div class="swiper-wrapper">'
                          ...
                          +'  </div>'
                       +' </div>'
                       +' <a class="pageBtn msg-confirmBtn gotoNext">确认</a>'
                    +'</div>'
                    +'<info></info>'
                   ...
                   +' <div class="step step-6" data-step=6>'
                     ...
                     +'   <div class="password">'
                      ...
                      +'      <div><label for="">确认密码</label><input required class="reInput" type="password"></div>'
                       +' </div>'
                    +'</div>'
